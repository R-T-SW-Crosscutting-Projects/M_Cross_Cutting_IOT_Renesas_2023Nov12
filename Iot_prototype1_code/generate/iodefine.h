...
/*                                                                            */
/* Device     : RL78/R5F11BBC                                                 */
/* File Name  : R5F11BBC.h                                                    */
/* Abstract   : Definition of Special Function Register (SFR)                 */
/* History    : V1.01  [Device File version]                                  */
/* Options    : -df=DR5F11BBC.DVF -o=R5F11BBC.h -f                            */
/* Date       : 2016/08/10                                                    */
/* Version    : V1.04.00.04  [df2iodef.exe version]                           */
/* This is a typical example.                                                 */
/*                                                                            */
/******************************************************************************/
#ifndef __R5F11BBCIODEFINE_HEADER__
#define __R5F11BBCIODEFINE_HEADER__
...
#define TIOS0        (*(volatile __near unsigned char  *)0x74)
...
#define TRXEN        (((volatile __near __bitf_T *)0x7A)->no1)
#define PWMOPEN      (((volatile __near __bitf_T *)0x7A)->no2)
#define DTCEN        (((volatile __near __bitf_T *)0x7A)->no3)
#define TRD0EN       (((volatile __near __bitf_T *)0x7A)->no4)
#define PGACMPEN     (((volatile __near __bitf_T *)0x7A)->no5)
...
#define C1OTWMD      (((volatile __near __bitf_T *)0x342)->no7)
...
#define PGACTL       (*(volatile __near unsigned char  *)0x347)
#define PGACTL_bit   (*(volatile __near __bitf_T *)0x347)
#define PGAEN        (((volatile __near __bitf_T *)0x347)->no7)
#define CMPSEL0      (*(volatile __near unsigned char  *)0x34A)
#define CMPSEL0_bit  (*(volatile __near __bitf_T *)0x34A)
#define CMPSEL1      (*(volatile __near unsigned char  *)0x34B)
#define CMPSEL1_bit  (*(volatile __near __bitf_T *)0x34B)
#define TRX          (*(volatile __near unsigned short *)0x350)
#define TRXBUF       (*(volatile __near unsigned short *)0x352)
#define TRXCR1       (*(volatile __near unsigned char  *)0x354)
#define TRXCR1_bit   (*(volatile __near __bitf_T *)0x354)
#define TRXCR2       (*(volatile __near unsigned char  *)0x355)
#define TRXCR2_bit   (*(volatile __near __bitf_T *)0x355)
#define TSTART       (((volatile __near __bitf_T *)0x355)->no0)
#define TRXSR        (*(volatile __near unsigned char  *)0x356)
#define TRXSR_bit    (*(volatile __near __bitf_T *)0x356)
#define TRXOVF       (((volatile __near __bitf_T *)0x356)->no0)
#define TRXSB        (((volatile __near __bitf_T *)0x356)->no1)
#define OPCTL0       (*(volatile __near unsigned char  *)0x358)
#define OPCTL0_bit   (*(volatile __near __bitf_T *)0x358)
#define OPDF0        (*(volatile __near unsigned char  *)0x359)
#define OPDF1        (*(volatile __near unsigned char  *)0x35A)
#define OPEDGE       (*(volatile __near unsigned char  *)0x35B)
#define OPSR         (*(volatile __near unsigned char  *)0x35C)
#define OPSR_bit     (*(volatile __near __bitf_T *)0x35C)
...
#define TRXIF        (((volatile __near __bitf_T *)0xFFD1)->no4)
...
#define TRXMK        (((volatile __near __bitf_T *)0xFFD5)->no4)
...
#define TRXPR0       (((volatile __near __bitf_T *)0xFFD9)->no4)
...
#define TRXPR1       (((volatile __near __bitf_T *)0xFFDD)->no4)
